...
async def test_build_print_command():
    ...
    command = app.print.build_print_command(file_png_path = "IMAGE", printer_model = "MODEL", label_type = "LABEL", printer_backend = "BACKEND", printer_url = "URL", red = True, low_quality = True, high_dpi = True, compress = True)
    ...
    command = app.print.build_print_command(file_png_path = "IMAGE", printer_model = "MODEL", label_type = "LABEL", printer_backend = "BACKEND", printer_url = "URL", red = False, low_quality = False, high_dpi = False, compress = False)
